...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ProduitBundle/Resources/views'), '!Produit');
        $instance->addPath(($this->targetDirs[3].'\\src\\bikeBundle/Resources/views'), 'bike');
        $instance->addPath(($this->targetDirs[3].'\\src\\bikeBundle/Resources/views'), '!bike');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'bikeBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\bikeBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'bikeBundle' => 'bikeBundle\\bikeBundle',
