...
class __TwigTemplate_2fd73045e79331461a8a08879b38a5ddf3a79aad0a5b3804a72d3dff87a8f061 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<form  class=\"box\" action=\"";
    ...
    ";
        // line 11
        if ((isset($context["csrf_token"]) || array_key_exists("csrf_token", $context) ? $context["csrf_token"] : (function () { throw new RuntimeError('Variable "csrf_token" does not exist.', 11, $this->source); })())) {
            // line 12
            echo "        <input type=\"hidden\" name=\"_csrf_token\" value=\"";
            echo twig_escape_filter($this->env, (isset($context["csrf_token"]) || array_key_exists("csrf_token", $context) ? $context["csrf_token"] : (function () { throw new RuntimeError('Variable "csrf_token" does not exist.', 12, $this->source); })()), "html", null, true);
            echo "\" />
    ";
        }
        // line 14
...
";
    ...
    public function block_stylesheet($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("login/style.css"), "html", null, true);
        echo "\">
";
    ...
    {
        return array (  117 => 4,  107 => 3,  94 => 23,  89 => 21,  82 => 17,  77 => 15,  72 => 14,  66 => 12,  64 => 11,  60 => 10,  57 => 9,  51 => 7,  49 => 6,  47 => 3,  44 => 2,);
    }
...
<form  class=\"box\" action=\"{{ path(\"fos_user_security_check\") }}\" method=\"post\">
    {% if csrf_token %}
...
", "@FOSUser/Security/login_content.html.twig", "C:\\wamp64\\www\\bicycle\\src\\UserBundle\\Resources\\views\\Security\\login_content.html.twig");
    }
}
