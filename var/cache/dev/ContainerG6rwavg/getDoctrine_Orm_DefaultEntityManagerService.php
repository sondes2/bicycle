...
include_once $this->targetDirs[3].'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\Mapping\\Driver\\PHPDriver.php';
...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\CommandeBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ProduitBundle\\Entity')]);
$d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([($this->targetDirs[3].'\\src\\EventBundle\\Resources\\config\\doctrine') => 'EventBundle\\Entity']);
...
$b->addDriver($c, 'CommandeBundle\\Entity');
$b->addDriver($c, 'ProduitBundle\\Entity');
$b->addDriver($d, 'EventBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'CommandeBundle' => 'CommandeBundle\\Entity', 'ProduitBundle' => 'ProduitBundle\\Entity', 'EventBundle' => 'EventBundle\\Entity']);
