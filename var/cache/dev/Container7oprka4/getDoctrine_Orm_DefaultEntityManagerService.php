...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\CommandeBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ProduitBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\bikeBundle\\Entity')]);
...
$b->addDriver($c, 'bikeBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'CommandeBundle' => 'CommandeBundle\\Entity', 'ProduitBundle' => 'ProduitBundle\\Entity', 'bikeBundle' => 'bikeBundle\\Entity', 'EventBundle' => 'EventBundle\\Entity']);
