 ...
 */
class lignecmd extends \CommandeBundle\Entity\lignecmd implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CommandeBundle\\Entity\\lignecmd' . "\0" . 'id', '' . "\0" . 'CommandeBundle\\Entity\\lignecmd' . "\0" . 'quantite', '' . "\0" . 'CommandeBundle\\Entity\\lignecmd' . "\0" . 'etat', '' . "\0" . 'CommandeBundle\\Entity\\lignecmd' . "\0" . 'cmd', '' . "\0" . 'CommandeBundle\\Entity\\lignecmd' . "\0" . 'produit', '' . "\0" . 'CommandeBundle\\Entity\\lignecmd' . "\0" . 'userid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (lignecmd $proxy) {
