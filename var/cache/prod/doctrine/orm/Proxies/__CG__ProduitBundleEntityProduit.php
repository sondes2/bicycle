  ...
  'image' => NULL,
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'libelle', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'qte', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'categorie', 'image'];
        }

        return ['__isInitialized__', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'libelle', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'qte', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'ProduitBundle\\Entity\\Produit' . "\0" . 'categorie'];
    }
