...
class Notification extends \AppBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'livreur', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'id', 'title', 'description', 'icon', 'route', 'parameters', 'date', 'seen', 'fullUrl'];
        }
