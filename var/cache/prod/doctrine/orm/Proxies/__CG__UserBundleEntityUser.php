...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'lignecmds', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function addLignecmds(\CommandeBundle\Entity\lignecmd $lignecmd): \UserBundle\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function removeLignecmds(\CommandeBundle\Entity\lignecmd $lignecmd): \UserBundle\Entity\User
    {
